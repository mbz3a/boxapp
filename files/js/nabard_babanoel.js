(function() {
  ...
  const elements = {
    ...
    santaHealthMeter: document.getElementsByClassName(
      "healthbar__santa-meter"
    )[0],
    krampusHealthMeter: document.getElementsByClassName(
  ...
  const fighters = {
    ...
    santaRightUpperArm: document.getElementsByClassName(
      "santa-r-arm__upper"
    )[0],
    santaRightLowerArm: document.getElementsByClassName(
      "santa-r-arm__lower"
    )[0],

    santaLeftUpperLeg: document.getElementsByClassName(
      "santa-legs__l-upper"
    )[0],
    santaLeftLowerLeg: document.getElementsByClassName(
      "santa-legs__l-lower"
    )[0],
    santaRightUpperLeg: document.getElementsByClassName(
      "santa-legs__r-upper"
    )[0],
    santaRightLowerLeg: document.getElementsByClassName(
      "santa-legs__r-lower"
    )[0],
    ...
    krampusLeftUpperArm: document.getElementsByClassName(
      "krampus-l-arm__upper"
    )[0],
    krampusLeftLowerArm: document.getElementsByClassName(
      "krampus-l-arm__lower"
    )[0],
    krampusRightUpperArm: document.getElementsByClassName(
      "krampus-r-arm__upper"
    )[0],
    krampusRightLowerArm: document.getElementsByClassName(
      "krampus-r-arm__lower"
    )[0],

    krampusLeftUpperLeg: document.getElementsByClassName(
      "krampus-legs__l-upper"
    )[0],
    krampusLeftLowerLeg: document.getElementsByClassName(
      "krampus-legs__l-lower"
    )[0],
    krampusRightUpperLeg: document.getElementsByClassName(
      "krampus-legs__r-upper"
    )[0],
    krampusRightLowerLeg: document.getElementsByClassName(
